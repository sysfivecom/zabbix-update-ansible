...
description:
   - Call the Zabbix API
   - This is an ansible module that does not follow the guide, but should work quickly as intended
   - Basically it is a lightweight Wrapper around zabbix-api package.
